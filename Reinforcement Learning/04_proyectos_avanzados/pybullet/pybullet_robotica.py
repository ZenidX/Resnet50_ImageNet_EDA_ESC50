...
Uso:
    python pybullet_robotica.py                    # Entrenar Ant
    python pybullet_robotica.py --env humanoid     # Entrenar Humanoide
    python pybullet_robotica.py --demo             # Ver agente
    python pybullet_robotica.py --compare          # Comparar robots
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--compare-robots", action="store_true", help="Comparar robots")
